                                ...
                                <div class="card-block">
                                   ...
                                   <div class="btn-group pull-right">
                                    ...
                                    <div class="btn-group pull-right">
                                        <a class="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-sort pull-right" aria-hidden="true"></i></a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#">Bug <img class="iconBug pull-right" src="./img/ladybug.png" style="width: 20px; height: 20px"></a>
                                            <a class="dropdown-item" href="#">Features <img class="iconBug pull-right" src="./img/star.png" style="width: 20px; height: 20px"></a>
                                        </div>
                                    </div>
